    ...
    {% if not is_popup %}
        ...
        {% if jazzmin_settings.show_sidebar %}
            ...
            <aside class="main-sidebar elevation-4 {{ jazzmin_ui.sidebar_classes }}" id="jazzy-sidebar">
                ...
                <div class="sidebar">
                    {% comment %} BARRA LATERAL INQUIERDA DEL NAVEGADOR {% endcomment %}
                ...
                {% comment %} LLEGAR A LA PAGINA DE INICIO  DESDE LA BARRA LATERAL DEL ADMIN {% endcomment %}
        <div class="p-3">
            <a href="{% url 'index' %}" class="btn btn-primary w-100">
